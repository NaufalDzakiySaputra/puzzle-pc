...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <!-- Card dengan flex column dan min-height -->
            <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition flex flex-col" style="min-height: 380px;">
                <!-- Gambar -->
                ...
                <div class="p-4 flex flex-col flex-grow">
                    <!-- Nama produk - bisa 2 baris -->
                    <h3 class="font-bold text-lg mb-1 line-clamp-2 min-h-[56px]">{{ $product->name }}</h3>
